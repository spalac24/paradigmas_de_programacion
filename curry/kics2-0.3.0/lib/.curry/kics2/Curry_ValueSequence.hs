...
module Curry_ValueSequence (C_ValueSequence (..), d_C_emptyVS, d_C_addVS, d_C_failVS, d_C_vsToList, d_OP_bar_plus_plus_bar) where
...
d_C_emptyVS :: Curry_Prelude.Curry t0 => Cover -> ConstStore -> C_ValueSequence t0
d_C_emptyVS x3250 x3500 = external_d_C_emptyVS x3250 x3500

d_C_addVS :: Curry_Prelude.Curry t0 => t0 -> C_ValueSequence t0 -> Cover -> ConstStore -> C_ValueSequence t0
d_C_addVS x1 x2 x3250 x3500 = external_d_C_addVS x1 x2 x3250 x3500

d_C_failVS :: Curry_Prelude.Curry t0 => Curry_Prelude.C_Int -> Cover -> ConstStore -> C_ValueSequence t0
d_C_failVS x1 x3250 x3500 = external_d_C_failVS x1 x3250 x3500

d_C_vsToList :: Curry_Prelude.Curry t0 => C_ValueSequence t0 -> Cover -> ConstStore -> Curry_Prelude.OP_List t0
d_C_vsToList x1 x3250 x3500 = external_d_C_vsToList x1 x3250 x3500

d_OP_bar_plus_plus_bar :: Curry_Prelude.Curry t0 => C_ValueSequence t0 -> C_ValueSequence t0 -> Cover -> ConstStore -> C_ValueSequence t0
d_OP_bar_plus_plus_bar x1 x2 x3250 x3500 = external_d_OP_bar_plus_plus_bar x1 x2 x3250 x3500
