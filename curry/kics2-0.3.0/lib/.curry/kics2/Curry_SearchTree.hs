...
instance Unifiable t0 => Unifiable (C_SearchTree t0) where
  ...
  bind _ _ (Choices_C_SearchTree cd i _) = error ("SearchTree.SearchTree.bind: Choices with ChoiceID: " ++ (show i))
  ...
  lazyBind _ _ (Choices_C_SearchTree cd i _) = error ("SearchTree.SearchTree.lazyBind: Choices with ChoiceID: " ++ (show i))
...
instance Unifiable t0 => Unifiable (C_AbortList t0) where
  ...
  bind _ _ (Choices_C_AbortList cd i _) = error ("SearchTree.AbortList.bind: Choices with ChoiceID: " ++ (show i))
  ...
  lazyBind _ _ (Choices_C_AbortList cd i _) = error ("SearchTree.AbortList.lazyBind: Choices with ChoiceID: " ++ (show i))
...
d_C_isDefined x1 x3250 x3500 = d_OP_isDefined_dot_hasValue_dot_4 (d_C_someSearchTree x1 x3250 x3500) x3250 x3500

d_OP_isDefined_dot_hasValue_dot_4 :: Curry_Prelude.Curry t0 => C_SearchTree t0 -> Cover -> ConstStore -> Curry_Prelude.C_Bool
d_OP_isDefined_dot_hasValue_dot_4 x1 x3250 x3500 = case x1 of
     (C_Value x2) -> Curry_Prelude.C_True
     (C_Fail x3) -> Curry_Prelude.C_False
     (C_Or x4 x5) -> Curry_Prelude.d_OP_bar_bar (d_OP_isDefined_dot_hasValue_dot_4 x4 x3250 x3500) (d_OP_isDefined_dot_hasValue_dot_4 x5 x3250 x3500) x3250 x3500
     (Choice_C_SearchTree x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_OP_isDefined_dot_hasValue_dot_4 x1002 x3250 x3500) (d_OP_isDefined_dot_hasValue_dot_4 x1003 x3250 x3500)
     (Choices_C_SearchTree x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_OP_isDefined_dot_hasValue_dot_4 z x3250 x3500) x1002
     (Guard_C_SearchTree x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_OP_isDefined_dot_hasValue_dot_4 x1002 x3250) $! (addCs x1001 x3500))
...
d_C_showSearchTree x1 x3250 x3500 = let
     x2 = d_OP_showSearchTree_dot_showChar_dot_16 (Curry_Prelude.C_Char '\n'#) x3250 x3500
      in (Curry_Prelude.d_C_apply (d_OP_showSearchTree_dot_showsST_dot_16 x2 Curry_Prelude.OP_List x1 x3250 x3500) Curry_Prelude.OP_List x3250 x3500)

d_OP_showSearchTree_dot_showChar_dot_16 :: Curry_Prelude.Curry t0 => t0 -> Cover -> ConstStore -> Curry_Prelude.OP_List t0 -> Cover -> ConstStore -> Curry_Prelude.OP_List t0
d_OP_showSearchTree_dot_showChar_dot_16 x1 x3250 x3500 = acceptCs id (Curry_Prelude.OP_Cons x1)

nd_OP_showSearchTree_dot_showChar_dot_16 :: Curry_Prelude.Curry t0 => t0 -> IDSupply -> Cover -> ConstStore -> Func (Curry_Prelude.OP_List t0) (Curry_Prelude.OP_List t0)
nd_OP_showSearchTree_dot_showChar_dot_16 x1 x3000 x3250 x3500 = wrapDX id (acceptCs id (Curry_Prelude.OP_Cons x1))

d_OP_showSearchTree_dot_showString_dot_16 :: Curry_Prelude.Curry t0 => Curry_Prelude.OP_List t0 -> Cover -> ConstStore -> Curry_Prelude.OP_List t0 -> Cover -> ConstStore -> Curry_Prelude.OP_List t0
d_OP_showSearchTree_dot_showString_dot_16 x1 x3250 x3500 = Curry_Prelude.d_OP_plus_plus x1

nd_OP_showSearchTree_dot_showString_dot_16 :: Curry_Prelude.Curry t0 => Curry_Prelude.OP_List t0 -> IDSupply -> Cover -> ConstStore -> Func (Curry_Prelude.OP_List t0) (Curry_Prelude.OP_List t0)
nd_OP_showSearchTree_dot_showString_dot_16 x1 x3000 x3250 x3500 = wrapDX id (Curry_Prelude.d_OP_plus_plus x1)

d_OP_showSearchTree_dot_indent_dot_16 :: Curry_Prelude.OP_List Curry_Prelude.C_Bool -> Cover -> ConstStore -> Curry_Prelude.OP_List Curry_Prelude.C_Char -> Cover -> ConstStore -> Curry_Prelude.OP_List Curry_Prelude.C_Char
d_OP_showSearchTree_dot_indent_dot_16 x1 x3250 x3500 = case x1 of
     Curry_Prelude.OP_List -> Curry_Prelude.d_C_id
     (Curry_Prelude.OP_Cons x2 x3) -> Curry_Prelude.d_OP_dot (d_OP_showSearchTree_dot_showString_dot_16 (Curry_Prelude.d_OP_dollar (Curry_Prelude.d_C_concatMap d_OP_showSearchTree_dot_indent_dot_16_dot_showIndent_dot_27 x3250 x3500) (Curry_Prelude.d_C_apply (Curry_Prelude.d_C_reverse x3250 x3500) x3 x3250 x3500) x3250 x3500) x3250 x3500) (Curry_Prelude.d_OP_dot (d_OP_showSearchTree_dot_showChar_dot_16 (d_OP__case_7 x2 x3250 x3500) x3250 x3500) (d_OP_showSearchTree_dot_showString_dot_16 (Curry_Prelude.OP_Cons (Curry_Prelude.C_Char (nonAsciiChr 9472#)) (Curry_Prelude.OP_Cons (Curry_Prelude.C_Char ' '#) Curry_Prelude.OP_List)) x3250 x3500) x3250 x3500) x3250 x3500
     (Curry_Prelude.Choice_OP_List x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_OP_showSearchTree_dot_indent_dot_16 x1002 x3250 x3500) (d_OP_showSearchTree_dot_indent_dot_16 x1003 x3250 x3500)
     (Curry_Prelude.Choices_OP_List x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_OP_showSearchTree_dot_indent_dot_16 z x3250 x3500) x1002
     (Curry_Prelude.Guard_OP_List x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_OP_showSearchTree_dot_indent_dot_16 x1002 x3250) $! (addCs x1001 x3500))
     (Curry_Prelude.Fail_OP_List x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo

nd_OP_showSearchTree_dot_indent_dot_16 :: Curry_Prelude.OP_List Curry_Prelude.C_Bool -> IDSupply -> Cover -> ConstStore -> Func (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char)
nd_OP_showSearchTree_dot_indent_dot_16 x1 x3000 x3250 x3500 = case x1 of
                              ...
                              x2006 = rightSupply x2005
                               in (seq x2004 (seq x2006 (let
                                   ...
                                   x2003 = rightSupply x2006
                                    in (seq x2000 (seq x2003 (Curry_Prelude.nd_OP_dollar (Curry_Prelude.nd_C_concatMap (wrapDX id d_OP_showSearchTree_dot_indent_dot_16_dot_showIndent_dot_27) x2000 x3250 x3500) (let
                         ...
                         x2013 = rightSupply x2012
                          in (seq x2011 (seq x2013 (let
                              ...
                              x2010 = rightSupply x2013
                               in (seq x2009 (seq x2010 (Curry_Prelude.nd_OP_dot (nd_OP_showSearchTree_dot_showChar_dot_16 (d_OP__case_7 x2 x3250 x3500) x2009 x3250 x3500) (nd_OP_showSearchTree_dot_showString_dot_16 (Curry_Prelude.OP_Cons (Curry_Prelude.C_Char (nonAsciiChr 9472#)) (Curry_Prelude.OP_Cons (Curry_Prelude.C_Char ' '#) Curry_Prelude.OP_List)) x2010 x3250 x3500) x2011 x3250 x3500))))))) x2014 x3250 x3500))))))))
     (Curry_Prelude.Choice_OP_List x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (nd_OP_showSearchTree_dot_indent_dot_16 x1002 x3000 x3250 x3500) (nd_OP_showSearchTree_dot_indent_dot_16 x1003 x3000 x3250 x3500)
     (Curry_Prelude.Choices_OP_List x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> nd_OP_showSearchTree_dot_indent_dot_16 z x3000 x3250 x3500) x1002
     (Curry_Prelude.Guard_OP_List x1000 x1001 x1002) -> guardCons x1000 x1001 ((nd_OP_showSearchTree_dot_indent_dot_16 x1002 x3000 x3250) $! (addCs x1001 x3500))
     (Curry_Prelude.Fail_OP_List x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo

d_OP_showSearchTree_dot_indent_dot_16_dot_showIndent_dot_27 :: Curry_Prelude.C_Bool -> Cover -> ConstStore -> Curry_Prelude.OP_List Curry_Prelude.C_Char
d_OP_showSearchTree_dot_indent_dot_16_dot_showIndent_dot_27 x1 x3250 x3500 = Curry_Prelude.OP_Cons (d_OP__case_6 x1 x3250 x3500) (Curry_Prelude.OP_Cons (Curry_Prelude.C_Char ' '#) (Curry_Prelude.OP_Cons (Curry_Prelude.C_Char ' '#) Curry_Prelude.OP_List))

d_OP_showSearchTree_dot_shows_dot_16 :: Curry_Prelude.Curry t0 => t0 -> Cover -> ConstStore -> Curry_Prelude.OP_List Curry_Prelude.C_Char -> Cover -> ConstStore -> Curry_Prelude.OP_List Curry_Prelude.C_Char
d_OP_showSearchTree_dot_shows_dot_16 x1 x3250 x3500 = d_OP_showSearchTree_dot_showString_dot_16 (Curry_Prelude.d_C_show x1 x3250 x3500) x3250 x3500

nd_OP_showSearchTree_dot_shows_dot_16 :: Curry_Prelude.Curry t0 => t0 -> IDSupply -> Cover -> ConstStore -> Func (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char)
nd_OP_showSearchTree_dot_shows_dot_16 x1 x3000 x3250 x3500 = let
     x2000 = x3000
      in (seq x2000 (nd_OP_showSearchTree_dot_showString_dot_16 (Curry_Prelude.d_C_show x1 x3250 x3500) x2000 x3250 x3500))
...
d_OP_showSearchTree_dot_showsST_dot_16 x1 x2 x3 x3250 x3500 = case x3 of
     (C_Value x4) -> Curry_Prelude.d_OP_dot (d_OP_showSearchTree_dot_indent_dot_16 x2 x3250 x3500) (Curry_Prelude.d_OP_dot (d_OP_showSearchTree_dot_shows_dot_16 x4 x3250 x3500) x1 x3250 x3500) x3250 x3500
     (C_Fail x5) -> Curry_Prelude.d_OP_dot (d_OP_showSearchTree_dot_indent_dot_16 x2 x3250 x3500) (Curry_Prelude.d_OP_dot (d_OP_showSearchTree_dot_showChar_dot_16 (Curry_Prelude.C_Char '!'#) x3250 x3500) x1 x3250 x3500) x3250 x3500
     (C_Or x6 x7) -> Curry_Prelude.d_OP_dot (d_OP_showSearchTree_dot_indent_dot_16 x2 x3250 x3500) (Curry_Prelude.d_OP_dot (d_OP_showSearchTree_dot_showChar_dot_16 (Curry_Prelude.C_Char '?'#) x3250 x3500) (Curry_Prelude.d_OP_dot x1 (Curry_Prelude.d_OP_dot (d_OP_showSearchTree_dot_showsST_dot_16 x1 (Curry_Prelude.OP_Cons Curry_Prelude.C_False x2) x6 x3250 x3500) (d_OP_showSearchTree_dot_showsST_dot_16 x1 (Curry_Prelude.OP_Cons Curry_Prelude.C_True x2) x7 x3250 x3500) x3250 x3500) x3250 x3500) x3250 x3500) x3250 x3500
     (Choice_C_SearchTree x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_OP_showSearchTree_dot_showsST_dot_16 x1 x2 x1002 x3250 x3500) (d_OP_showSearchTree_dot_showsST_dot_16 x1 x2 x1003 x3250 x3500)
     (Choices_C_SearchTree x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_OP_showSearchTree_dot_showsST_dot_16 x1 x2 z x3250 x3500) x1002
     (Guard_C_SearchTree x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_OP_showSearchTree_dot_showsST_dot_16 x1 x2 x1002 x3250) $! (addCs x1001 x3500))
     (Fail_C_SearchTree x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo
...
nd_OP_showSearchTree_dot_showsST_dot_16 x1 x2 x3 x3000 x3250 x3500 = case x3 of
     (C_Value x4) -> let
          x2005 = x3000
           in (seq x2005 (let
               x2004 = leftSupply x2005
               x2006 = rightSupply x2005
                in (seq x2004 (seq x2006 (let
                    x2000 = leftSupply x2006
                    x2003 = rightSupply x2006
                     in (seq x2000 (seq x2003 (Curry_Prelude.nd_OP_dot (nd_OP_showSearchTree_dot_indent_dot_16 x2 x2000 x3250 x3500) (let
                         x2002 = leftSupply x2003
                         x2001 = rightSupply x2003
                          in (seq x2002 (seq x2001 (Curry_Prelude.nd_OP_dot (nd_OP_showSearchTree_dot_shows_dot_16 x4 x2001 x3250 x3500) x1 x2002 x3250 x3500)))) x2004 x3250 x3500))))))))
     (C_Fail x5) -> let
          x2005 = x3000
           in (seq x2005 (let
               x2004 = leftSupply x2005
                ...
                in (seq x2004 (seq x2006 (let
                    ...
                    x2003 = rightSupply x2006
                     in (seq x2000 (seq x2003 (Curry_Prelude.nd_OP_dot (nd_OP_showSearchTree_dot_indent_dot_16 x2 x2000 x3250 x3500) (let
                         x2002 = leftSupply x2003
                         x2001 = rightSupply x2003
                          in (seq x2002 (seq x2001 (Curry_Prelude.nd_OP_dot (nd_OP_showSearchTree_dot_showChar_dot_16 (Curry_Prelude.C_Char '!'#) x2001 x3250 x3500) x1 x2002 x3250 x3500)))) x2004 x3250 x3500))))))))
     (C_Or x6 x7) -> let
          x2013 = x3000
           in (seq x2013 (let
               ...
               x2014 = rightSupply x2013
                in (seq x2012 (seq x2014 (let
                    ...
                    x2010 = rightSupply x2014
                     in (seq x2000 (seq x2010 (Curry_Prelude.nd_OP_dot (nd_OP_showSearchTree_dot_indent_dot_16 x2 x2000 x3250 x3500) (let
                         x2009 = leftSupply x2010
                         x2011 = rightSupply x2010
                          in (seq x2009 (seq x2011 (let
                              x2001 = leftSupply x2011
                              x2008 = rightSupply x2011
                               in (seq x2001 (seq x2008 (Curry_Prelude.nd_OP_dot (nd_OP_showSearchTree_dot_showChar_dot_16 (Curry_Prelude.C_Char '?'#) x2001 x3250 x3500) (let
                                   x2007 = leftSupply x2008
                                   x2005 = rightSupply x2008
                                    in (seq x2007 (seq x2005 (Curry_Prelude.nd_OP_dot x1 (let
                                        ...
                                        x2006 = rightSupply x2005
                                         in (seq x2004 (seq x2006 (let
                                             ...
                                             x2003 = rightSupply x2006
                                              in (seq x2002 (seq x2003 (Curry_Prelude.nd_OP_dot (nd_OP_showSearchTree_dot_showsST_dot_16 x1 (Curry_Prelude.OP_Cons Curry_Prelude.C_False x2) x6 x2002 x3250 x3500) (nd_OP_showSearchTree_dot_showsST_dot_16 x1 (Curry_Prelude.OP_Cons Curry_Prelude.C_True x2) x7 x2003 x3250 x3500) x2004 x3250 x3500))))))) x2007 x3250 x3500)))) x2009 x3250 x3500))))))) x2012 x3250 x3500))))))))
     (Choice_C_SearchTree x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (nd_OP_showSearchTree_dot_showsST_dot_16 x1 x2 x1002 x3000 x3250 x3500) (nd_OP_showSearchTree_dot_showsST_dot_16 x1 x2 x1003 x3000 x3250 x3500)
     (Choices_C_SearchTree x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> nd_OP_showSearchTree_dot_showsST_dot_16 x1 x2 z x3000 x3250 x3500) x1002
     (Guard_C_SearchTree x1000 x1001 x1002) -> guardCons x1000 x1001 ((nd_OP_showSearchTree_dot_showsST_dot_16 x1 x2 x1002 x3000 x3250) $! (addCs x1001 x3500))
     (Fail_C_SearchTree x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo
...
d_C_idsStrategyWith x1 x2 x3 x3250 x3500 = d_OP_idsStrategyWith_dot_iterIDS_dot_108 x2 x3 x1 (d_C_collectInBounds (Curry_Prelude.C_Int 0#) x1 x3 x3250 x3500) x3250 x3500
...
nd_C_idsStrategyWith x1 x2 x3 x3000 x3250 x3500 = let
     x2000 = x3000
      in (seq x2000 (nd_OP_idsStrategyWith_dot_iterIDS_dot_108 x2 x3 x1 (d_C_collectInBounds (Curry_Prelude.C_Int 0#) x1 x3 x3250 x3500) x2000 x3250 x3500))

d_OP_idsStrategyWith_dot_iterIDS_dot_108 :: Curry_Prelude.Curry t0 => (Curry_Prelude.C_Int -> Cover -> ConstStore -> Curry_Prelude.C_Int) -> C_SearchTree t0 -> Curry_Prelude.C_Int -> C_AbortList t0 -> Cover -> ConstStore -> Curry_ValueSequence.C_ValueSequence t0
d_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x4 x3250 x3500 = case x4 of
     C_Nil -> Curry_ValueSequence.d_C_emptyVS x3250 x3500
     (C_Cons x5 x6) -> Curry_ValueSequence.d_C_addVS x5 (d_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x6 x3250 x3500) x3250 x3500
     (C_FCons x7 x8) -> Curry_ValueSequence.d_OP_bar_plus_plus_bar (Curry_ValueSequence.d_C_failVS x7 x3250 x3500) (d_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x8 x3250 x3500) x3250 x3500
     C_Abort -> let
          x9 = Curry_Prelude.d_C_apply x1 x3 x3250 x3500
           in (d_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x9 (d_C_collectInBounds x3 x9 x2 x3250 x3500) x3250 x3500)
     (Choice_C_AbortList x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x1002 x3250 x3500) (d_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x1003 x3250 x3500)
     (Choices_C_AbortList x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 z x3250 x3500) x1002
     (Guard_C_AbortList x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x1002 x3250) $! (addCs x1001 x3500))
     (Fail_C_AbortList x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo

nd_OP_idsStrategyWith_dot_iterIDS_dot_108 :: Curry_Prelude.Curry t0 => Func Curry_Prelude.C_Int Curry_Prelude.C_Int -> C_SearchTree t0 -> Curry_Prelude.C_Int -> C_AbortList t0 -> IDSupply -> Cover -> ConstStore -> Curry_ValueSequence.C_ValueSequence t0
nd_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x4 x3000 x3250 x3500 = case x4 of
     C_Nil -> Curry_ValueSequence.d_C_emptyVS x3250 x3500
     (C_Cons x5 x6) -> let
          x2000 = x3000
           in (seq x2000 (Curry_ValueSequence.d_C_addVS x5 (nd_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x6 x2000 x3250 x3500) x3250 x3500))
     (C_FCons x7 x8) -> let
          x2000 = x3000
           in (seq x2000 (Curry_ValueSequence.d_OP_bar_plus_plus_bar (Curry_ValueSequence.d_C_failVS x7 x3250 x3500) (nd_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x8 x2000 x3250 x3500) x3250 x3500))
     C_Abort -> let
          x2002 = x3000
           in (seq x2002 (let
               ...
               x2001 = rightSupply x2002
                in (seq x2000 (seq x2001 (let
                    x9 = Curry_Prelude.nd_C_apply x1 x3 x2000 x3250 x3500
                     in (nd_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x9 (d_C_collectInBounds x3 x9 x2 x3250 x3500) x2001 x3250 x3500))))))
     (Choice_C_AbortList x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (nd_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x1002 x3000 x3250 x3500) (nd_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x1003 x3000 x3250 x3500)
     (Choices_C_AbortList x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> nd_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 z x3000 x3250 x3500) x1002
     (Guard_C_AbortList x1000 x1001 x1002) -> guardCons x1000 x1001 ((nd_OP_idsStrategyWith_dot_iterIDS_dot_108 x1 x2 x3 x1002 x3000 x3250) $! (addCs x1001 x3500))
     (Fail_C_AbortList x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo
...
d_C_collectInBounds x1 x2 x3 x3250 x3500 = d_OP_collectInBounds_dot_collectLevel_dot_122 x2 x1 x2 x3 x3250 x3500

d_OP_collectInBounds_dot_collectLevel_dot_122 :: Curry_Prelude.Curry t0 => Curry_Prelude.C_Int -> Curry_Prelude.C_Int -> Curry_Prelude.C_Int -> C_SearchTree t0 -> Cover -> ConstStore -> C_AbortList t0
d_OP_collectInBounds_dot_collectLevel_dot_122 x1 x2 x3 x4 x3250 x3500 = case x4 of
     ...
     (Choice_C_SearchTree x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_OP_collectInBounds_dot_collectLevel_dot_122 x1 x2 x3 x1002 x3250 x3500) (d_OP_collectInBounds_dot_collectLevel_dot_122 x1 x2 x3 x1003 x3250 x3500)
     (Choices_C_SearchTree x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_OP_collectInBounds_dot_collectLevel_dot_122 x1 x2 x3 z x3250 x3500) x1002
     (Guard_C_SearchTree x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_OP_collectInBounds_dot_collectLevel_dot_122 x1 x2 x3 x1002 x3250) $! (addCs x1001 x3500))
     (Fail_C_SearchTree x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo
...
d_C_getAllValuesWith x1 x2 x3250 x3500 = Curry_Prelude.d_OP_gt_gt_eq (d_C_getSearchTree x2 x3250 x3500) (d_OP_getAllValuesWith_dot___hash_lambda2 x1) x3250 x3500
...
nd_C_getAllValuesWith x1 x2 x3000 x3250 x3500 = let
     x2000 = x3000
      in (seq x2000 (Curry_Prelude.nd_OP_gt_gt_eq (d_C_getSearchTree x2 x3250 x3500) (wrapNX id (nd_OP_getAllValuesWith_dot___hash_lambda2 x1)) x2000 x3250 x3500))

d_OP_getAllValuesWith_dot___hash_lambda2 :: Curry_Prelude.Curry t0 => (C_SearchTree t0 -> Cover -> ConstStore -> Curry_ValueSequence.C_ValueSequence t0) -> C_SearchTree t0 -> Cover -> ConstStore -> Curry_Prelude.C_IO (Curry_Prelude.OP_List t0)
d_OP_getAllValuesWith_dot___hash_lambda2 x1 x2 x3250 x3500 = Curry_Prelude.d_C_return (Curry_ValueSequence.d_C_vsToList (Curry_Prelude.d_C_apply x1 x2 x3250 x3500) x3250 x3500) x3250 x3500

nd_OP_getAllValuesWith_dot___hash_lambda2 :: Curry_Prelude.Curry t0 => Func (C_SearchTree t0) (Curry_ValueSequence.C_ValueSequence t0) -> C_SearchTree t0 -> IDSupply -> Cover -> ConstStore -> Curry_Prelude.C_IO (Curry_Prelude.OP_List t0)
nd_OP_getAllValuesWith_dot___hash_lambda2 x1 x2 x3000 x3250 x3500 = let
     x2000 = x3000
...
d_OP__case_1 x3 x8 x2 x1 x7 x9 x3250 x3500 = case x9 of
     Curry_Prelude.C_True -> d_C_concA (d_OP_collectInBounds_dot_collectLevel_dot_122 x1 x2 (Curry_Prelude.d_OP_minus x3 (Curry_Prelude.C_Int 1#) x3250 x3500) x7 x3250 x3500) (d_OP_collectInBounds_dot_collectLevel_dot_122 x1 x2 (Curry_Prelude.d_OP_minus x3 (Curry_Prelude.C_Int 1#) x3250 x3500) x8 x3250 x3500) x3250 x3500
