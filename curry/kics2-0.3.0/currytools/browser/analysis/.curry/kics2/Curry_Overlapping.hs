...
d_C_orInExpr x1 x3250 x3500 = case x1 of
     ...
     (Curry_FlatCurry.C_Case x13 x14 x15) -> Curry_Prelude.d_OP_bar_bar (d_C_orInExpr x14 x3250 x3500) (Curry_Prelude.d_C_apply (Curry_Prelude.d_C_any d_OP_orInExpr_dot_orInBranch_dot_34 x3250 x3500) x15 x3250 x3500) x3250 x3500
...
d_OP_orInExpr_dot_orInBranch_dot_34 :: Curry_FlatCurry.C_BranchExpr -> Cover -> ConstStore -> Curry_Prelude.C_Bool
d_OP_orInExpr_dot_orInBranch_dot_34 x1 x3250 x3500 = case x1 of
     (Curry_FlatCurry.C_Branch x2 x3) -> d_C_orInExpr x3 x3250 x3500
     (Curry_FlatCurry.Choice_C_BranchExpr x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_OP_orInExpr_dot_orInBranch_dot_34 x1002 x3250 x3500) (d_OP_orInExpr_dot_orInBranch_dot_34 x1003 x3250 x3500)
     (Curry_FlatCurry.Choices_C_BranchExpr x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_OP_orInExpr_dot_orInBranch_dot_34 z x3250 x3500) x1002
     (Curry_FlatCurry.Guard_C_BranchExpr x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_OP_orInExpr_dot_orInBranch_dot_34 x1002 x3250) $! (addCs x1001 x3500))
