...
module Curry_Linearity (d_C_analyseRightLinearity, nd_C_analyseRightLinearity, d_C_hasRightLinearRules, d_C_linearExpr) where
...
d_C_analyseRightLinearity :: Cover -> ConstStore -> Curry_Prelude.OP_List Curry_FlatCurry.C_FuncDecl -> Cover -> ConstStore -> Curry_Prelude.OP_List (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char)) Curry_Prelude.C_Bool)
d_C_analyseRightLinearity x3250 x3500 = Curry_Dependency.d_C_analyseWithDependencies d_C_hasRightLinearRules (Curry_Prelude.d_C_and x3250 x3500)

nd_C_analyseRightLinearity :: IDSupply -> Cover -> ConstStore -> Func (Curry_Prelude.OP_List Curry_FlatCurry.C_FuncDecl) (Curry_Prelude.OP_List (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char)) Curry_Prelude.C_Bool))
nd_C_analyseRightLinearity x3000 x3250 x3500 = let
     x2000 = x3000
      in (seq x2000 (wrapNX id (Curry_Dependency.nd_C_analyseWithDependencies (wrapDX id d_C_hasRightLinearRules) (Curry_Prelude.nd_C_and x2000 x3250 x3500))))
...
d_OP_linearVariables_dot_patternVars_dot_44 :: Curry_FlatCurry.C_BranchExpr -> Cover -> ConstStore -> Curry_Prelude.OP_List Curry_Prelude.C_Int
d_OP_linearVariables_dot_patternVars_dot_44 x1 x3250 x3500 = case x1 of
     (Curry_FlatCurry.C_Branch x2 x3) -> d_OP__case_1 x2 x3250 x3500
     (Curry_FlatCurry.Choice_C_BranchExpr x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_OP_linearVariables_dot_patternVars_dot_44 x1002 x3250 x3500) (d_OP_linearVariables_dot_patternVars_dot_44 x1003 x3250 x3500)
     (Curry_FlatCurry.Choices_C_BranchExpr x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_OP_linearVariables_dot_patternVars_dot_44 z x3250 x3500) x1002
     (Curry_FlatCurry.Guard_C_BranchExpr x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_OP_linearVariables_dot_patternVars_dot_44 x1002 x3250) $! (addCs x1001 x3500))
...
d_OP_linearVariables_dot___hash_lambda7_dot___hash_lambda9_dot___hash_lambda10 x1 x3250 x3500 = case x1 of
     (Curry_Prelude.OP_Tuple2 x2 x3) -> Curry_List.d_OP_backslash_backslash x3 (d_OP_linearVariables_dot_patternVars_dot_44 x2 x3250 x3500) x3250 x3500
