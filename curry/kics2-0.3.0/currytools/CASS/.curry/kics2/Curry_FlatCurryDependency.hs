...
d_C_dependsDirectlyOnTypes :: Curry_FlatCurry.C_TypeDecl -> Cover -> ConstStore -> Curry_Prelude.OP_List (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char))
d_C_dependsDirectlyOnTypes x1 x3250 x3500 = case x1 of
     (Curry_FlatCurry.C_Type x2 x3 x4 x5) -> Curry_List.d_C_nub (Curry_Prelude.d_C_apply (Curry_Prelude.d_C_concatMap d_OP_dependsDirectlyOnTypes_dot___hash_lambda1 x3250 x3500) x5 x3250 x3500) x3250 x3500
     (Curry_FlatCurry.C_TypeSyn x6 x7 x8 x9) -> Curry_List.d_C_nub (d_C_tconsOf x9 x3250 x3500) x3250 x3500
     (Curry_FlatCurry.Choice_C_TypeDecl x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_C_dependsDirectlyOnTypes x1002 x3250 x3500) (d_C_dependsDirectlyOnTypes x1003 x3250 x3500)
     (Curry_FlatCurry.Choices_C_TypeDecl x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_C_dependsDirectlyOnTypes z x3250 x3500) x1002
     (Curry_FlatCurry.Guard_C_TypeDecl x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_C_dependsDirectlyOnTypes x1002 x3250) $! (addCs x1001 x3500))
     (Curry_FlatCurry.Fail_C_TypeDecl x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo

d_OP_dependsDirectlyOnTypes_dot___hash_lambda1 :: Curry_FlatCurry.C_ConsDecl -> Cover -> ConstStore -> Curry_Prelude.OP_List (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char))
d_OP_dependsDirectlyOnTypes_dot___hash_lambda1 x1 x3250 x3500 = case x1 of
     (Curry_FlatCurry.C_Cons x2 x3 x4 x5) -> Curry_Prelude.d_C_apply (Curry_Prelude.d_C_concatMap d_C_tconsOf x3250 x3500) x5 x3250 x3500
     (Curry_FlatCurry.Choice_C_ConsDecl x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_OP_dependsDirectlyOnTypes_dot___hash_lambda1 x1002 x3250 x3500) (d_OP_dependsDirectlyOnTypes_dot___hash_lambda1 x1003 x3250 x3500)
     (Curry_FlatCurry.Choices_C_ConsDecl x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_OP_dependsDirectlyOnTypes_dot___hash_lambda1 z x3250 x3500) x1002
     (Curry_FlatCurry.Guard_C_ConsDecl x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_OP_dependsDirectlyOnTypes_dot___hash_lambda1 x1002 x3250) $! (addCs x1001 x3500))
     (Curry_FlatCurry.Fail_C_ConsDecl x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo

d_C_tconsOf :: Curry_FlatCurry.C_TypeExpr -> Cover -> ConstStore -> Curry_Prelude.OP_List (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char))
d_C_tconsOf x1 x3250 x3500 = case x1 of
     (Curry_FlatCurry.C_TVar x2) -> Curry_Prelude.OP_List
     (Curry_FlatCurry.C_FuncType x3 x4) -> Curry_Prelude.d_OP_plus_plus (d_C_tconsOf x3 x3250 x3500) (d_C_tconsOf x4 x3250 x3500) x3250 x3500
     (Curry_FlatCurry.C_TCons x5 x6) -> Curry_Prelude.OP_Cons x5 Curry_Prelude.OP_List
     (Curry_FlatCurry.Choice_C_TypeExpr x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_C_tconsOf x1002 x3250 x3500) (d_C_tconsOf x1003 x3250 x3500)
     (Curry_FlatCurry.Choices_C_TypeExpr x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_C_tconsOf z x3250 x3500) x1002
     (Curry_FlatCurry.Guard_C_TypeExpr x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_C_tconsOf x1002 x3250) $! (addCs x1001 x3500))
...
d_C_directlyDependent x1 x3250 x3500 = case x1 of
     (Curry_FlatCurry.C_Func x2 x3 x4 x5 x6) -> d_OP__case_2 x2 x6 x3250 x3500
...
nd_C_directlyDependent x1 x3000 x3250 x3500 = case x1 of
     (Curry_FlatCurry.C_Func x2 x3 x4 x5 x6) -> let
          x2000 = x3000
           in (seq x2000 (nd_OP__case_2 x2 x6 x2000 x3250 x3500))
...
d_C_funcSetOfExpr x1 x3250 x3500 = case x1 of
     ...
     (Curry_FlatCurry.C_Case x13 x14 x15) -> Curry_SetRBT.d_C_unionRBT (d_C_funcSetOfExpr x14 x3250 x3500) (Curry_Prelude.d_C_apply (d_C_unionMap d_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 x3250 x3500) x15 x3250 x3500) x3250 x3500
                    ...
                    x2003 = rightSupply x2006
                     in (seq x2000 (seq x2003 (Curry_SetRBT.nd_C_unionRBT (nd_C_funcSetOfExpr x14 x2000 x3250 x3500) (let
                         ...
                         x2001 = rightSupply x2003
                          in (seq x2002 (seq x2001 (Curry_Prelude.nd_C_apply (nd_C_unionMap (wrapNX id nd_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54) x2001 x3250 x3500) x15 x2002 x3250 x3500)))) x2004 x3250 x3500))))))))
...
d_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 :: Curry_FlatCurry.C_BranchExpr -> Cover -> ConstStore -> Curry_RedBlackTree.C_RedBlackTree (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char))
d_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 x1 x3250 x3500 = case x1 of
     (Curry_FlatCurry.C_Branch x2 x3) -> d_C_funcSetOfExpr x3 x3250 x3500
     (Curry_FlatCurry.Choice_C_BranchExpr x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 x1002 x3250 x3500) (d_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 x1003 x3250 x3500)
     (Curry_FlatCurry.Choices_C_BranchExpr x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 z x3250 x3500) x1002
     (Curry_FlatCurry.Guard_C_BranchExpr x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 x1002 x3250) $! (addCs x1001 x3500))
     (Curry_FlatCurry.Fail_C_BranchExpr x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo

nd_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 :: Curry_FlatCurry.C_BranchExpr -> IDSupply -> Cover -> ConstStore -> Curry_RedBlackTree.C_RedBlackTree (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char))
nd_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 x1 x3000 x3250 x3500 = case x1 of
     (Curry_FlatCurry.C_Branch x2 x3) -> let
          x2000 = x3000
           in (seq x2000 (nd_C_funcSetOfExpr x3 x2000 x3250 x3500))
     (Curry_FlatCurry.Choice_C_BranchExpr x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (nd_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 x1002 x3000 x3250 x3500) (nd_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 x1003 x3000 x3250 x3500)
     (Curry_FlatCurry.Choices_C_BranchExpr x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> nd_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 z x3000 x3250 x3500) x1002
     (Curry_FlatCurry.Guard_C_BranchExpr x1000 x1001 x1002) -> guardCons x1000 x1001 ((nd_OP_funcSetOfExpr_dot_funcSetOfBranch_dot_54 x1002 x3000 x3250) $! (addCs x1001 x3500))
     (Curry_FlatCurry.Fail_C_BranchExpr x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo
...
d_OP__case_0 x4 x3 x2 x3250 x3500 = case x2 of
     (Curry_Prelude.OP_Tuple2 x5 x6) -> Curry_Prelude.d_OP_lt_eq (Curry_Prelude.d_OP_plus_plus x3 (Curry_Prelude.OP_Cons (Curry_Prelude.C_Char '.'#) x4) x3250 x3500) (Curry_Prelude.d_OP_plus_plus x5 (Curry_Prelude.OP_Cons (Curry_Prelude.C_Char '.'#) x6) x3250 x3500) x3250 x3500
...
d_OP__case_2 x2 x6 x3250 x3500 = case x6 of
     ...
     (Curry_FlatCurry.Choice_C_Rule x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (d_OP__case_2 x2 x1002 x3250 x3500) (d_OP__case_2 x2 x1003 x3250 x3500)
     (Curry_FlatCurry.Choices_C_Rule x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> d_OP__case_2 x2 z x3250 x3500) x1002
     (Curry_FlatCurry.Guard_C_Rule x1000 x1001 x1002) -> guardCons x1000 x1001 ((d_OP__case_2 x2 x1002 x3250) $! (addCs x1001 x3500))
     (Curry_FlatCurry.Fail_C_Rule x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo

nd_OP__case_2 :: Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char) -> Curry_FlatCurry.C_Rule -> IDSupply -> Cover -> ConstStore -> Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char)) (Curry_RedBlackTree.C_RedBlackTree (Curry_Prelude.OP_Tuple2 (Curry_Prelude.OP_List Curry_Prelude.C_Char) (Curry_Prelude.OP_List Curry_Prelude.C_Char)))
nd_OP__case_2 x2 x6 x3000 x3250 x3500 = case x6 of
     ...
     (Curry_FlatCurry.Choice_C_Rule x1000 x1001 x1002 x1003) -> narrow x1000 x1001 (nd_OP__case_2 x2 x1002 x3000 x3250 x3500) (nd_OP__case_2 x2 x1003 x3000 x3250 x3500)
     (Curry_FlatCurry.Choices_C_Rule x1000 x1001 x1002) -> narrows x3500 x1000 x1001 (\z -> nd_OP__case_2 x2 z x3000 x3250 x3500) x1002
     (Curry_FlatCurry.Guard_C_Rule x1000 x1001 x1002) -> guardCons x1000 x1001 ((nd_OP__case_2 x2 x1002 x3000 x3250) $! (addCs x1001 x3500))
     (Curry_FlatCurry.Fail_C_Rule x1000 x1001) -> failCons x1000 x1001
     _ -> failCons x3250 defFailInfo
