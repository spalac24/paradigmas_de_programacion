...
--- <A HREF="http://www.tzi.de/daVinci/">daVinci graph drawing tool</A>
--- through the following features:
--- <UL>
--- <LI> Graphs are displayed by the main functions dvDisplay or dvDisplayInit
---
--- <LI> Graphs to be displayed are constructed by the functions:
--- <PRE>
...
--- </PRE>
--- <LI> The constructors dvSimpleNode/dvNodeWithEdges/dvSimpleEdge
...
--- 
--- <LI> The constructor functions for graph entities take an event handler
...
--
--- <LI> There are a number of predefined event handlers to manipulate
...
initDvSchedule initgraph dvport initcmd =
  let p,s,ans1,ans2 free in
    ...
    openPort p s &>
    initcmd p &>
    ((dvSchedule (map (ensureNotFree id) (ensureSpine s)) evs idindex p dvport) &
     (dvAdaptor p dvport))
