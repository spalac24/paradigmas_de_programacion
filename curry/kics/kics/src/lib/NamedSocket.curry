...
module NamedSocket(Socket.Socket,
                   listenOn, socketListen, socketAccept, waitForSocketAccept,
                   connectToSocketRepeat, connectToSocketWait, connectToSocket)
 where
...
listenOn :: String -> IO Socket.Socket
...
socketAccept :: Socket.Socket -> IO (String,Handle)
socketAccept = Socket.socketAccept
...
waitForSocketAccept :: Socket.Socket -> Int -> IO (Maybe (String,Handle))
waitForSocketAccept = Socket.waitForSocketAccept


--- Defines the maximum backlog queue of a port.
socketListen :: Socket.Socket -> Int -> IO ()
socketListen = Socket.socketListen
