...
module Curry_nondet (nd_C_choose, nd_C_one23, nd_C_last) where
          ...
          x2001 = rightSupply x2002
           in (seq x2000 (seq x2001 (let
               ...
               x3 = generate x2001 x3250
                in (d_OP___cond_0_last x3 (Curry_Prelude.d_OP_eq_colon_eq (Curry_Prelude.d_OP_plus_plus x2 (Curry_Prelude.OP_Cons x3 Curry_Prelude.OP_List) x3250 x3500) x1 x3250 x3500) x3250 x3500))))))
